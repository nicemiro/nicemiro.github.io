...
GRANT CREATE SESSION TO MYPDB_ADMIN;    -- 접속권한 부여
GRANT CREATE USER TO MYPDB_ADMIN;       -- 유저생성 권한
GRANT ALTER USER TO MYPDB_ADMIN         -- 유저변경 권한
...
GRANT DEV_DDL_ROLE TO DEV_USER1; -- 개발자에게 롤 부여
```
