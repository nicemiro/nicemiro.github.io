...
<br>
### 운영배포 시뮬레이션
도커를 사용해 리눅스 컨테이너 안에서 빌드 및 테스트를 진행하여 운영서버 배포 이전의 개발단계를 시뮬레이션 해보자.   
...
UID 와 GID 가 0 번 root 권한을 갖게햣되면 컨테이너를 통한 호스트의 시스템을 조작이 가능하게 된다.  
